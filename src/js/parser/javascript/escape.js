...
export default {
  ...
  W: ['non-word', -1, false],
  1: function() {
    return [`Back reference (group = 1${this.arg})`, -1, false];
  },
  2: function() {
    return [`Back reference (group = 2${this.arg})`, -1, false];
  },
  3: function() {
    return [`Back reference (group = 3${this.arg})`, -1, false];
  },
  4: function() {
    return [`Back reference (group = 4${this.arg})`, -1, false];
  },
  5: function() {
    return [`Back reference (group = 5${this.arg})`, -1, false];
  },
  6: function() {
    return [`Back reference (group = 6${this.arg})`, -1, false];
  },
  7: function() {
    return [`Back reference (group = 7${this.arg})`, -1, false];
  },
  8: function() {
    return [`Back reference (group = 8${this.arg})`, -1, false];
  },
  9: function() {
    return [`Back reference (group = 9${this.arg})`, -1, false];
  },
  0: function() {
    if (this.arg) {
